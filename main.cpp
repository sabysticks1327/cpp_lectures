...
constexpr std::string_view PRODUCT_NAMES[static_cast<int>(Product::count)] = {
    [static_cast<int>(Product::decoration)] = "decoration",
    [static_cast<int>(Product::toiletries)] = "toiletries",
    ...
    [static_cast<int>(Product::international)]= "international",
};

/// @brief Checks if the given product is valid.  //no use
constexpr auto is_valid_product(Product prod) { return prod > Product::invalid && prod < Product::count; }

/// @brief Return the name of the given product.  //no use
